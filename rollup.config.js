...
const standaloneBaseConfig = {
  ...
  input: './src/index.js',
  output: {
    file: 'dist/react-native-hooks-camera-roll.js',
    format: 'umd',
    globals,
    name: 'react-native-hooks-camera-roll',
    sourcemap: true,
  },
...
const standaloneProdConfig = {
  ...
  output: {
    ...
    file: 'dist/react-native-hooks-camera-roll.min.js',
  },
...
const nativeConfig = {
  ...
  output: [
    getCJS({
      file: 'dist/react-native-hooks-camera-roll.cjs.js',
    }),
    getESM({
      file: 'dist/react-native-hooks-camera-roll.esm.js',
    }),
  ],
};
